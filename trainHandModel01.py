# Training using scratch algorithm
...
model = Sequential()
model.add(Conv2D(128,(3,3),input_shape=(dimSz,dimSz,3),activation='relu'))
...
model_checkpoint_callback = ModelCheckpoint(rootPath+kfold+"\\xmodel\\hand_best_model_"+kfold+"_"+str(img_width)+"_epoch_"+str(epochs)+".h5", 
    monitor='val_acc', 
    verbose=1,
    save_best_only=True, 
    mode='max', 
